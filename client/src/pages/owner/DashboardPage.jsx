...
import { StatCardSkeleton } from "../../components/owner/StatCardSkeleton";
        ...
        <div className="p-4 md:p-8 max-w-5xl mx-auto flex flex-col gap-6">
            ...
            <section className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                {summaryLoading ? (
                    ...
                    <>
                        <StatCard label="Active Projects" value={summary?.activeProjectsCount ?? 0} icon={Building2} />
                        <StatCard label="Total Clients" value={summary?.totalClients ?? 0} icon={Users} />
                        <StatCard
                            label="Balance Due"
